 ...
 */
public class AsyncListDifferWithoutMoves<T> {
     ...
     */
    public AsyncListDifferWithoutMoves(@NonNull RecyclerView.Adapter adapter,
    ...
    public AsyncListDifferWithoutMoves(@NonNull ListUpdateCallback listUpdateCallback,
